...
#Region " Properties" '---------------------------------------------------------------------------------------------------
    ...
    Private _mode As String = "Select" 'The mouse mode for the chart: Select - crosshair pointer Pan - Hand pointer
...
#Region "Methods" '-------------------------------------------------------------------------------------------------------
    ...
    Public Sub LoadFile(ByRef myFileName As String, ByRef myChart As System.Windows.Forms.DataVisualization.Charting.Chart)
        'Load the Point Chart settings from the selected file.
        ...
        If XDoc.<ChartSettings>.<Mode>.Value <> Nothing Then Mode = XDoc.<ChartSettings>.<Mode>.Value
        If XDoc.<ChartSettings>.<SelectedSeriesName>.Value <> Nothing Then SelSeries = XDoc.<ChartSettings>.<SelectedSeriesName>.Value
        If XDoc.<ChartSettings>.<SelectedChartAreaName>.Value <> Nothing Then SelChartArea = XDoc.<ChartSettings>.<SelectedChartAreaName>.Value
    ...
    Public Sub LoadXml(ByRef XDoc As System.Xml.Linq.XDocument, ByRef myChart As System.Windows.Forms.DataVisualization.Charting.Chart)
        'Load the Point Chart settings from the XDocument.
        'This will update properties in ChartInfo and the myChart control.
    ...
    Public Function ToXDoc(ByRef myChart As System.Windows.Forms.DataVisualization.Charting.Chart) As System.Xml.Linq.XDocument
        ...
        Dim XDoc = <?xml version="1.0" encoding="utf-8"?>
                   ...
                   <ChartSettings>
                       <!--User Selections:-->
                       <Mode><%= Mode %></Mode>
                       <SelectedSeriesName><%= SelSeries %></SelectedSeriesName>
                       <SelectedChartAreaName><%= SelChartArea %></SelectedChartAreaName>
                       <!--Input Data:-->
